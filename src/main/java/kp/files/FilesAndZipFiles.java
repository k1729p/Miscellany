...
public class FilesAndZipFiles {
	...
	public void readFiles() {
		...
		try {
			...
			try (Stream<String> linesStream = Files.newBufferedReader(ConstantsForFiles.EXAMPLE_XML_PATH).lines()) {
	...
	public void listFilesInZipFile() {
		...
		try (Stream<? extends ZipEntry> zipEntryStream = new ZipFile(ConstantsForFiles.EXAMPLE_ZIP_PATH.toString())
				.stream()) {
