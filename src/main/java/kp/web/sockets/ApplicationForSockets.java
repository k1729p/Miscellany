...
/*-
 * The Java Secure Socket Extension (JSSE) Reference Guide (for Java SE 17):
...
public class ApplicationForSockets {
	...
	public ApplicationForSockets() {
		...
		/*-
		With code line 'System.setProperty("javax.net.debug", "all");'
		it will enable the JSSE system debugging property for secure sockets.
		 */
	}
