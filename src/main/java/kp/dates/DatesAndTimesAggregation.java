...
public class DatesAndTimesAggregation {
	...
	private List<LocalDateTime> createDateList() {
		...
		for (LocalDateTime date = Constants.EXAMPLE_LOCAL_DATE_TIME.minusYears(1); date
	...
	private void iterateOverYears(
		...
		yMap.forEach((key, value) -> iterateOverMonths(value, atomic));
	}
	...
	private void iterateOverMonths(
		...
		mMap.forEach((key, value) -> iterateOverDays(value, atomic));
	}
	...
	private void iterateOverDays(//
		...
		dMap.forEach((key, value) -> iterateOverHours(value, atomic));
	}
	...
	private void iterateOverHours(
		...
		hMap.forEach((key, value) -> iterateOverMinutes(value, atomic));
	}
	...
	private void showSelectedDates(
		...
		datesByFieldsMap
				.forEach((key5, value5) -> value5.forEach((key4, value4) -> value4.forEach((key3, value3) -> value3
						.forEach((key2, value2) -> value2.forEach((key1, value1) -> value1.forEach((key, value) -> {
